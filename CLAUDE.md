...
## v6 핵심 변경사항
- **진짜 경쟁자 재정의**: ChatGPT + 지인 네트워크 (사업계획서 작성 툴이 아님)
- **인터뷰 완료 후 분기**: [1. 랜딩페이지 자동 제작] 또는 [2. 사업계획서 자동 제작]
- **경쟁자 포지션**: ChatGPT는 "좋아 보여요"만 돌아오지만 Foal AI는 실제 고객 유입 데이터로 검증
...
POST /api/output/landing-copy     → 랜딩페이지 카피 초안 (1 크레딧)
POST /api/output/gov-match        → 정부지원사업 매칭 (1 크레딧)
...
- STEP 5: 페인포인트 검증 — 기존 해결 방식 및 지불 의향 확인
- STEP 6: 차별점 발굴 — 기존 방법 대비 10배 더 나은 이유
- STEP 7: 창업자 강점 연결 — 경력·경험·네트워크와 문제 연결
- STEP 8: 리소스 파악 — 지금 당장 필요한 것과 보유한 것
- STEP 9: 다음 1주일 액션
